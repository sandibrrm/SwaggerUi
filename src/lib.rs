...
#[derive(Debug)]
pub struct SwaggerUiProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SwaggerUiProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SwaggerUi processing");
    
    let mut processor = SwaggerUiProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SwaggerUiProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SwaggerUiProcessor::new(false);
